...
class LoansFragment : Fragment(), OnPropositionClickListener,
    ...
    override fun onCreateView(
        ...
        thisView = inflater.inflate(R.layout.fragment_loans, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (Application.data.loans != null)
            adapter.setData(Application.data.loans as MutableList<Proposition>)
        else
            adapter.clear()
